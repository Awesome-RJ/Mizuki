...
__help__ = """\x1f*Commands:* \x1f• `/app <app name>`*:* Get details of play store apps.\x1f• `/phone <phone no>`*:* Get details of phone numbers.\x1f• `/yts <query>`*:* Search for a youtube video link and details.\x1f• `/so <query>`*:* Search solutions for a problem in stack overflow.\x1f• `/gh <query>`*:* Search github repos and users.\x1f• `/reverse`*:* Does a *reverse image search* of the media which it was replied to.\x1f\x1fReports bugs at @MizukiSupport\x1f"""
