...
from Mizuki import CMD_LIST, LOAD_PLUG, MONGO_DB_URI, tbot, telethn, ubot
...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        path = Path(f"Mizuki/advanced/{shortname}.py")
        name = "Mizuki.advanced.{}".format(shortname)
        ...
        spec.loader.exec_module(mod)
        sys.modules[f"Mizuki.advanced.{shortname}"] = mod
        print(f"Successfully imported {shortname}")


path = "Mizuki/advanced/*.py"
